...
public class Ticket extends Object {
  ...
  @Override public String toString() {
    return "Ticket{" +
        ...
        ", myTicketKey=" + myTicketKey +
        ", isEncryptedState=" + isEncryptedState +
        '}';
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (myStartTime != ticket.myStartTime)
      return false;
    if (myEndTime != ticket.myEndTime)
      return false;
    if (mySessionKey != ticket.mySessionKey)
      return false;
    if (myTicketKey != ticket.myTicketKey)
      return false;
    if (isEncryptedState != ticket.isEncryptedState)
      return false;
    if (myClientName != null ?
        !myClientName.equals(ticket.myClientName) :
        ticket.myClientName != null)
      return false;
    if (myServerName != null ?
        !myServerName.equals(ticket.myServerName) :
        ticket.myServerName != null)
      return false;
    return !(cal != null ? !cal.equals(ticket.cal) : ticket.cal != null);

  }

  @Override public int hashCode() {
    int result = myClientName != null ? myClientName.hashCode() : 0;
    result = 31 * result + (myServerName != null ? myServerName.hashCode() : 0);
    result = 31 * result + (int) (myStartTime ^ (myStartTime >>> 32));
    result = 31 * result + (int) (myEndTime ^ (myEndTime >>> 32));
    result = 31 * result + (int) (mySessionKey ^ (mySessionKey >>> 32));
    result = 31 * result + (int) (myTicketKey ^ (myTicketKey >>> 32));
    result = 31 * result + (isEncryptedState ? 1 : 0);
