...
public class Auth extends Object {
  ...
  public void printError(String message) {
    System.out.println("+++++++++++++++++++");
    System.out.println(
        "+++++++++++++++++++ Fehler +++++++++++++++++++ " + message + "! Auth-Key: " + myAuthKey);
    System.out.println("+++++++++++++++++++");
  }
  ...
  private String getDateString(long time) {
    ...
    dateString = cal.get(Calendar.DAY_OF_MONTH) + "." + (cal.get(Calendar.MONTH) + 1) + "." + cal
        .get(Calendar.YEAR) + " " + cal.get(Calendar.HOUR_OF_DAY) + ":" + cal.get(Calendar.MINUTE)
